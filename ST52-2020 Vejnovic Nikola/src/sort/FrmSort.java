...
public class FrmSort extends JFrame {
	...
	public FrmSort() {
		...
		btnSort.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(!dlm.isEmpty()) //ako nije prazna 
				{
					...
					JOptionPane.showMessageDialog(pnlSouth, "Rectangles are sorted by area!", "Sorted!", JOptionPane.INFORMATION_MESSAGE);
				} else
					JOptionPane.showMessageDialog(pnlSouth, "The list is empty!", "Warning", JOptionPane.ERROR_MESSAGE);
		...
		setTitle("Vejnovic Nikola ST52-2020");
